  ...
  return (
    <div className="w-full overflow-auto">
      <Table className="whitespace-pre product-table">
        <TableHead>
          <TableRow>
            <TableCell align="center" className="px-1 font-bold">Agent Code</TableCell>
            <TableCell align="center" className="px-1 font-bold">Agent Type</TableCell>
            <TableCell align="center" className="px-1 font-bold">Agent Name</TableCell>
            <TableCell align="center" className="px-1 font-bold">Email</TableCell>
            <TableCell align="center" className="px-1 font-bold">CPD Code</TableCell>
            <TableCell align="center" className="px-1 font-bold">License Number</TableCell>
            <TableCell align="center" className="px-1 font-bold">License Expiry Date</TableCell>
            <TableCell align="center" className="px-1 font-bold">Agency Office</TableCell>
